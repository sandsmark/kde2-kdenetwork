...
void destruct(int sigNumber)
{
   ...
   cout<<"signal caught: "<<sigNumber<<", exiting"<<endl;
...
{
   cout<<"readConfig(): signal caught: "<<sigNumber<<endl;
...
{
   cout<<"printState(): signal caught: "<<sigNumber<<endl;
