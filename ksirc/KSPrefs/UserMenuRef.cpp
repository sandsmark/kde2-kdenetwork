/**********************************************************************
 ...
 $$Id: UserMenuRef.cpp 76649 2001-01-06 16:05:31Z malte $$
...
void UserMenuRef::insertMenu()
{
  ...
  if(MenuType->currentItem() == UserControlMenu::Text){
    user_menu->insert(newitem,
		      new UserControlMenu((MenuName->text()),
					  (MenuCommand->text()),
					  -1,
    ...
    user_menu->insert(newitem, new UserControlMenu);
  }
