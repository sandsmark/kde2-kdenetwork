  ...
  : KPanelApplet(configFile, type, actions, parent, name), waiting(0)
{
  ...
  QToolTip::add(textLabel,i18n("Lookup a word or phrase with Kdict"));
  ...
  QToolTip::add(iconLabel,i18n("Lookup a word or phrase with Kdict"));
  ...
  QToolTip::add(clipboardBtn,i18n("Define current clipboard content"));
  ...
  QToolTip::add(internalCombo,i18n("Lookup a word or phrase with Kdict"));
  ...
  QToolTip::add(verticalBtn,i18n("Lookup a word or phrase with Kdict"));
  ...
  internalCombo->completionObject()->setItems(list);
  externalCombo->completionObject()->setItems(list);
...
DictApplet::~DictApplet()
{
  ...
  QStringList list = internalCombo->completionObject()->items();
